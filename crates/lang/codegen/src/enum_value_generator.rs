...
#[allow(clippy::indexing_slicing)] // Bounds: values[0] guarded by !values.is_empty() check
...
fn to_pascal_case(s: &str) -> String {
    ...
    if s == "do" {
        return "Do_".to_owned(); // "do" is a reserved keyword
    }
...
mod tests {
    ...
    fn test_generate_single_enum() {
        let enum_info = EnumInfo {
            ...
            values: vec![
                EnumValue {
                    name: "in".to_owned(),
                    comment: Some("Input direction.".to_owned()),
                },
                EnumValue {
                    name: "out".to_owned(),
                    comment: Some("Output direction.".to_owned()),
                },
                EnumValue {
                    name: "inout".to_owned(),
                    comment: None,
            ...
            comment: Some("Direction of a feature.".to_owned()),
        };
    ...
    fn test_handles_reserved_keyword_do() {
        let enum_info = EnumInfo {
            name: "StateSubactionKind".to_owned(),
            values: vec![
                EnumValue {
                    name: "entry".to_owned(),
                    comment: None,
